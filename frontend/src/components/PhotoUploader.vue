<template>
  <section class="space-y-3">
    <div
      ...
      @drop.prevent="onDrop"
    >
      <p class="text-base text-ts-text">Drag photos here</p>
      <p class="mt-1 text-sm text-ts-muted">JPEG, PNG, WebP, GIF</p>
    ...
    <div v-if="uploading" class="space-y-2">
      ...
      <p class="text-sm text-ts-muted">Upload progress: {{ progress }}%</p>
    </div>
  </section>
</template>
