...
const en: MessageSchema = {
  ...
  settings: {
    ...
    backup: {
      ...
      exportDescription: 'Download database, original photos, and music files as one zip archive.',
      exportAction: 'Export Backup',
      exporting: 'Exporting Backup...',
      exportSuccess: 'Backup exported successfully.',
      importTitle: 'Import Backup',
      importDescription: 'Restore from a backup zip and replace current data.',
