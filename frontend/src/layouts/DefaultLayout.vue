  ...
  <div data-testid="default-layout" class="min-h-screen bg-ts-bg text-ts-text">
    <div class="flex min-h-screen flex-col md:flex-row">
      <aside class="hidden w-72 border-r border-white/10 bg-ts-panel md:flex md:flex-col">
        <div class="px-6 py-5">
          <p class="text-2xl font-semibold tracking-wide text-ts-accent">TimeSand</p>
          <p class="mt-2 text-sm text-ts-muted">Smart photo wall and music box</p>
        </div>
      ...
      <div class="flex min-h-screen flex-1 flex-col">
        <header class="border-b border-white/10 bg-ts-panel px-4 py-4 md:hidden">
          <div class="flex items-center justify-between">
            <p class="text-lg font-semibold text-ts-accent">TimeSand</p>
            <button
              type="button"
